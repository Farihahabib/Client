      ...
      <MyContainer>
        <div className="flex  items-center justify-center container mx-auto py-12">
          <form
            ...
            className="fieldset shadow-2xl border-base-300 bg-[#FF7F50] rounded-box w-xs border  p-4"
          >
            <h1 className="fieldset-legend pt-5 flex justify-center items-center text-xl text-white font-bold">
              Login
            </h1>
            ...
            <div className="relative">
              ...
              <span
                ...
                className=" absolute right-2  top-[26px] z-50"
              >
                {show ? <FaEye /> : <IoEyeOff />}
              </span>
            </div>
            ...
            <button
              ...
              className="btn btn-neutral bg-teal-600 border-none mt-4"
            >
            ...
            <p className="text-white font-bold text-center py-3">
              ...
              <NavLink to={"/Register"}>
                <button className="border-b">...Register Now</button>
              </NavLink>{" "}
            </p>
          </form>
        </div>
