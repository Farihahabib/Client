...
console.log(reviews,foodName,reviewer)
//   const {
//     _id,
//     photo,
//     foodName,
...
console.log(foodName)
  const handleAddToFavourites = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        'http://localhost:3000/myfavourites',
        favouriteReview
      );
  ...
  return (
    <div className="shadow-xl mx-1 transition ease-in-out hover:scale-104 rounded-xl overflow-hidden">
      {/* Image */}
      <div className="img h-35 rounded-t-2xl overflow-hidden">
      ...
      <div className="btns flex gap-3 mx-auto justify-center mb-2">
        ...
        <button
          ...
          className="btn btn-square hover:text-white flex items-center justify-center"
          disabled={loading}
        >
          {loading ? (
            <DotLoader size={20} color="#FF4500" />
          ) : (
            <svg
...
//     const {_id, photo ,foodName,restaurantName,restaurantLocation,reviewer} = review;
...
//       fetch('http://localhost:3000/myfavourites',{
//         method:'POST',
//         headers:{
...
//     return (
//         <>
// <div className='shadow-xl mx-1 transition ease-in-out  hover:scale-104 '>
//     <div className="img h-35  rounded-t-2xl overflow-hidden ">
